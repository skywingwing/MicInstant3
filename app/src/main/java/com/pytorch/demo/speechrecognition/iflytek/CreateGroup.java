...
public class CreateGroup {
    ...
    //构造函数,为成员变量赋值
    public CreateGroup(String requestUrl,String APPID,String apiSecret,String apiKey,String GroupID,String FeatureID){
    ...
    //提供给主函数调用的方法
    public static void doCreateGroup(String requestUrl,String APPID,String apiSecret,String apiKey,String GroupID,String FeatureID){
        CreateGroup createGroup = new CreateGroup(requestUrl,APPID,apiSecret,apiKey,GroupID,FeatureID);
        try {
