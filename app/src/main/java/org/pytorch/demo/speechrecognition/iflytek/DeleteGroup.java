...
public class DeleteGroup {
    ...
    //构造函数,为成员变量赋值
    public DeleteGroup(String requestUrl,String APPID,String apiSecret,String apiKey){
    ...
    //提供给主函数调用的方法
    public static void doDeleteGroup(String requestUrl,String APPID,String apiSecret,String apiKey){
        DeleteGroup deleteGroup = new DeleteGroup(requestUrl,APPID,apiSecret,apiKey);
        try {
            String resp = deleteGroup.doRequest();
            System.out.println("resp=>"+resp);
            JsonParse myJsonParse = json.fromJson(resp, JsonParse.class);
            String textBase64Decode=new String(Base64.getDecoder().decode(myJsonParse.payload.deleteGroupRes.text), "UTF-8");
